...
// Bonus - ES6 Syntax: Use ES6 Syntax in your answer. Feel free to add on new methods or properties to  incorporate
...
const Emmanuel = new Person ("Emmanuel","Frontend Developer for Red Ventures", 22);
...
const MrMassey = new Programmer("Emmanuel", "Frontend Developer at Red Ventures", 22, ["JavaScript"]);
console.log(MrMassey.name);